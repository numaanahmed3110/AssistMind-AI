...
const Hero = () => {
  return (
    <main className="px-2 md:px-6 lg:px-12 pt-4 md:pt-7 pb-16 md:pb-20">
      <div
        className="rounded-xl text-center text-white pt-16 md:pt-15 pb-0 md:pb-0 px-6 relative overflow-hidden"
        style={{
